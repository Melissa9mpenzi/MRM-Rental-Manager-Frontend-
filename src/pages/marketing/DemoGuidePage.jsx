...
import { HACKATHON_TRACKS, SUI_DEPLOYMENT, JUDGE_ONE_LINER, WALRUS_USE_CASES } from "../../config/hackathonPositioning";
  ...
  return (
    <div className="min-h-screen bg-[#060a0e] px-4 py-12 text-white">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 text-lg text-white/75">{PITCH_LINE}</p>
        ...
        <h2 className="mt-10 text-lg font-bold">DeFi & Payments flow (primary)</h2>
        ...
        <h2 className="mt-10 text-lg font-bold">Demo accounts</h2>
